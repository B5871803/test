...
export function EntOperativeFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntOperative {
    ...
    return {
        ...
        'operativeName': !exists(json, 'operativeName') ? undefined : json['operativeName'],
        'operativeType': !exists(json, 'operativeType') ? undefined : json['operativeType'],
    };
}
...
export function EntOperativeToJSON(value?: EntOperative | null): any {
    ...
    return {
        ...
        'id': value.id,
        'operativeName': value.operativeName,
        'operativeType': value.operativeType,
    };
}
