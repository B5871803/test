...
export interface EntNurseEdges {
     ...
     */
    nurseop?: Array<EntOperativerecord>;
}
...
export function EntNurseEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntNurseEdges {
    ...
    return {
        ...
        'nurseop': !exists(json, 'nurseop') ? undefined : ((json['nurseop'] as Array<any>).map(EntOperativerecordFromJSON)),
    };
}
...
export function EntNurseEdgesToJSON(value?: EntNurseEdges | null): any {
    ...
    return {
        ...
        'nurseop': value.nurseop === undefined ? undefined : ((value.nurseop as Array<any>).map(EntOperativerecordToJSON)),
    };
}
