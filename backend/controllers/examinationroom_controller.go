...
func (ctl *ExaminationroomController) CreateExaminationroom(c *gin.Context) {
	...
	u, err := ctl.client.Examinationroom.
		Create().
...
// GetExaminationroom handles GET requests to retrieve a examinationroom entity
...
func (ctl *ExaminationroomController) ListExaminationroom(c *gin.Context) {
	...
	examinationroom, err := ctl.client.Examinationroom.
		Query().
		Limit(limit).
		Offset(offset).
...
// NewExaminationroomController creates and registers handles for the examinationroom controller
