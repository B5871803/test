...
func (ctl *OperativeController) ListOperative(c *gin.Context) {
	...
	operative, err := ctl.client.Operative.
		Query().
		Limit(limit).
		Offset(offset).
...
// NewOperativeController creates and registers handles for the operative controller
