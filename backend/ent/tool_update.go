...
func (tu *ToolUpdate) SetAmount(s string) *ToolUpdate {
	tu.mutation.SetAmount(s)
	return tu
}

// AddFromtoolIDs adds the fromtool edge to Operativerecord by ids.
func (tu *ToolUpdate) AddFromtoolIDs(ids ...int) *ToolUpdate {
	tu.mutation.AddFromtoolIDs(ids...)
	return tu
}

// AddFromtool adds the fromtool edges to Operativerecord.
func (tu *ToolUpdate) AddFromtool(o ...*Operativerecord) *ToolUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return tu.AddFromtoolIDs(ids...)
}
...
func (tu *ToolUpdate) RemoveFromtoolIDs(ids ...int) *ToolUpdate {
	tu.mutation.RemoveFromtoolIDs(ids...)
	return tu
}

// RemoveFromtool removes fromtool edges to Operativerecord.
func (tu *ToolUpdate) RemoveFromtool(o ...*Operativerecord) *ToolUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return tu.RemoveFromtoolIDs(ids...)
}
...
func (tu *ToolUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := tu.mutation.ToolName(); ok {
		if err := tool.ToolNameValidator(v); err != nil {
			return 0, &ValidationError{Name: "toolName", err: fmt.Errorf("ent: validator failed for field \"toolName\": %w", err)}
		}
	}
...
func (tu *ToolUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := tu.mutation.RemovedFromtoolIDs(); len(nodes) > 0 {
	...
	if nodes := tu.mutation.FromtoolIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tool.FromtoolTable,
...
// SetAmount sets the amount field.
func (tuo *ToolUpdateOne) SetAmount(s string) *ToolUpdateOne {
	tuo.mutation.SetAmount(s)
	return tuo
}

// AddFromtoolIDs adds the fromtool edge to Operativerecord by ids.
func (tuo *ToolUpdateOne) AddFromtoolIDs(ids ...int) *ToolUpdateOne {
	tuo.mutation.AddFromtoolIDs(ids...)
	return tuo
}

// AddFromtool adds the fromtool edges to Operativerecord.
func (tuo *ToolUpdateOne) AddFromtool(o ...*Operativerecord) *ToolUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return tuo.AddFromtoolIDs(ids...)
}
...
// RemoveFromtoolIDs removes the fromtool edge to Operativerecord by ids.
func (tuo *ToolUpdateOne) RemoveFromtoolIDs(ids ...int) *ToolUpdateOne {
	tuo.mutation.RemoveFromtoolIDs(ids...)
	return tuo
}

// RemoveFromtool removes fromtool edges to Operativerecord.
func (tuo *ToolUpdateOne) RemoveFromtool(o ...*Operativerecord) *ToolUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return tuo.RemoveFromtoolIDs(ids...)
}
...
func (tuo *ToolUpdateOne) sqlSave(ctx context.Context) (t *Tool, err error) {
	...
	if nodes := tuo.mutation.RemovedFromtoolIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tool.FromtoolTable,
	...
	if nodes := tuo.mutation.FromtoolIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   tool.FromtoolTable,
