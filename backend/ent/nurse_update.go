...
func (nu *NurseUpdate) AddNurseopIDs(ids ...int) *NurseUpdate {
	nu.mutation.AddNurseopIDs(ids...)
	return nu
}

// AddNurseop adds the nurseop edges to Operativerecord.
func (nu *NurseUpdate) AddNurseop(o ...*Operativerecord) *NurseUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return nu.AddNurseopIDs(ids...)
}
...
func (nu *NurseUpdate) RemoveNurseopIDs(ids ...int) *NurseUpdate {
	nu.mutation.RemoveNurseopIDs(ids...)
	return nu
}

// RemoveNurseop removes nurseop edges to Operativerecord.
func (nu *NurseUpdate) RemoveNurseop(o ...*Operativerecord) *NurseUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return nu.RemoveNurseopIDs(ids...)
}
...
func (nu *NurseUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := nu.mutation.RemovedNurseopIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   nurse.NurseopTable,
			Columns: []string{nurse.NurseopColumn},
			Bidi:    false,
	...
	if nodes := nu.mutation.NurseopIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   nurse.NurseopTable,
...
// AddNurseopIDs adds the nurseop edge to Operativerecord by ids.
func (nuo *NurseUpdateOne) AddNurseopIDs(ids ...int) *NurseUpdateOne {
	nuo.mutation.AddNurseopIDs(ids...)
	return nuo
}

// AddNurseop adds the nurseop edges to Operativerecord.
func (nuo *NurseUpdateOne) AddNurseop(o ...*Operativerecord) *NurseUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return nuo.AddNurseopIDs(ids...)
}
...
// RemoveNurseopIDs removes the nurseop edge to Operativerecord by ids.
func (nuo *NurseUpdateOne) RemoveNurseopIDs(ids ...int) *NurseUpdateOne {
	nuo.mutation.RemoveNurseopIDs(ids...)
	return nuo
}

// RemoveNurseop removes nurseop edges to Operativerecord.
func (nuo *NurseUpdateOne) RemoveNurseop(o ...*Operativerecord) *NurseUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return nuo.RemoveNurseopIDs(ids...)
}
...
func (nuo *NurseUpdateOne) sqlSave(ctx context.Context) (n *Nurse, err error) {
	...
	if nodes := nuo.mutation.RemovedNurseopIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   nurse.NurseopTable,
	...
	if nodes := nuo.mutation.NurseopIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   nurse.NurseopTable,
