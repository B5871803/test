...
import (
	...
	"github.com/B5871803/app/ent/migrate"
...
// QueryFromexaminationroom queries the fromexaminationroom edge of a Examinationroom.
func (c *ExaminationroomClient) QueryFromexaminationroom(e *Examinationroom) *OperativerecordQuery {
...
// QueryNurseop queries the nurseop edge of a Nurse.
func (c *NurseClient) QueryNurseop(n *Nurse) *OperativerecordQuery {
	query := &OperativerecordQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := n.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(operativerecord.Table, operativerecord.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, nurse.NurseopTable, nurse.NurseopColumn),
		)
...
// QueryFromoperative queries the fromoperative edge of a Operative.
func (c *OperativeClient) QueryFromoperative(o *Operative) *OperativerecordQuery {
	query := &OperativerecordQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := o.ID
		step := sqlgraph.NewStep(
...
// QueryFromtool queries the fromtool edge of a Tool.
func (c *ToolClient) QueryFromtool(t *Tool) *OperativerecordQuery {
	query := &OperativerecordQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(operativerecord.Table, operativerecord.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, tool.FromtoolTable, tool.FromtoolColumn),
		)
