...
var (
	...
	OperativerecordsColumns = []*schema.Column{
		...
		{Name: "operative_type", Type: field.TypeInt, Nullable: true},
		{Name: "tool_name", Type: field.TypeInt, Nullable: true},
	}
	...
	OperativerecordsTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:  "operativerecords_examinationrooms_fromexaminationroom",
			...
			{
				Symbol:  "operativerecords_nurses_nurseop",
			...
			{
				Symbol:  "operativerecords_operatives_fromoperative",
			...
			{
				Symbol:  "operativerecords_tools_fromtool",
