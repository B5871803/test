...
func (ou *OperativeUpdate) AddFromoperativeIDs(ids ...int) *OperativeUpdate {
	ou.mutation.AddFromoperativeIDs(ids...)
	return ou
}

// AddFromoperative adds the fromoperative edges to Operativerecord.
func (ou *OperativeUpdate) AddFromoperative(o ...*Operativerecord) *OperativeUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ou.AddFromoperativeIDs(ids...)
}
...
func (ou *OperativeUpdate) RemoveFromoperativeIDs(ids ...int) *OperativeUpdate {
	ou.mutation.RemoveFromoperativeIDs(ids...)
	return ou
}

// RemoveFromoperative removes fromoperative edges to Operativerecord.
func (ou *OperativeUpdate) RemoveFromoperative(o ...*Operativerecord) *OperativeUpdate {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ou.RemoveFromoperativeIDs(ids...)
}
...
func (ou *OperativeUpdate) Save(ctx context.Context) (int, error) {
	if v, ok := ou.mutation.OperativeType(); ok {
		if err := operative.OperativeTypeValidator(v); err != nil {
			return 0, &ValidationError{Name: "operativeType", err: fmt.Errorf("ent: validator failed for field \"operativeType\": %w", err)}
		}
	}
	if v, ok := ou.mutation.OperativeName(); ok {
		if err := operative.OperativeNameValidator(v); err != nil {
			return 0, &ValidationError{Name: "operativeName", err: fmt.Errorf("ent: validator failed for field \"operativeName\": %w", err)}
		}
	}
...
func (ou *OperativeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := ou.mutation.RemovedFromoperativeIDs(); len(nodes) > 0 {
	...
	if nodes := ou.mutation.FromoperativeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operative.FromoperativeTable,
...
// AddFromoperativeIDs adds the fromoperative edge to Operativerecord by ids.
func (ouo *OperativeUpdateOne) AddFromoperativeIDs(ids ...int) *OperativeUpdateOne {
	ouo.mutation.AddFromoperativeIDs(ids...)
	return ouo
}

// AddFromoperative adds the fromoperative edges to Operativerecord.
func (ouo *OperativeUpdateOne) AddFromoperative(o ...*Operativerecord) *OperativeUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ouo.AddFromoperativeIDs(ids...)
}
...
// RemoveFromoperativeIDs removes the fromoperative edge to Operativerecord by ids.
func (ouo *OperativeUpdateOne) RemoveFromoperativeIDs(ids ...int) *OperativeUpdateOne {
	ouo.mutation.RemoveFromoperativeIDs(ids...)
	return ouo
}

// RemoveFromoperative removes fromoperative edges to Operativerecord.
func (ouo *OperativeUpdateOne) RemoveFromoperative(o ...*Operativerecord) *OperativeUpdateOne {
	ids := make([]int, len(o))
	for i := range o {
		ids[i] = o[i].ID
	}
	return ouo.RemoveFromoperativeIDs(ids...)
}
...
func (ouo *OperativeUpdateOne) sqlSave(ctx context.Context) (o *Operative, err error) {
	...
	if nodes := ouo.mutation.RemovedFromoperativeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operative.FromoperativeTable,
	...
	if nodes := ouo.mutation.FromoperativeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   operative.FromoperativeTable,
