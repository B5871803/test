    ...
    "definitions": {
        ...
        "ent.Examinationroom": {
            ...
            "properties": {
                ...
                "examinationroomName": {
                    "description": "ExaminationroomName holds the value of the \"examinationroomName\" field.",
                    "type": "string"
                },
                "id": {
        ...
        "ent.ExaminationroomEdges": {
            ...
            "properties": {
                "fromexaminationroom": {
                    "description": "Fromexaminationroom holds the value of the fromexaminationroom edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Operativerecord"
                    }
